...
export const parks: Park[] = [
  ...
  },
  {
    ...
    name: '青年公園',
    district: '台北市萬華區',
    address: '台北市萬華區水源路 199 號',
    meeting: '青年公園 1 號門入口（水源路口）',
    lat: 25.0219,
    lng: 121.5061,
  },
  {
  ...
  },
  {
    ...
    name: '花博公園圓山園區',
    district: '台北市中山區',
    address: '台北市中山區玉門街 1 號',
    meeting: '捷運圓山站 1 號出口花博廣場',
    lat: 25.0716,
    lng: 121.5202,
  },
  {
  ...
  },
  {
    ...
    name: '大湖公園',
    district: '台北市內湖區',
    address: '台北市內湖區成功路五段 31 號',
    meeting: '捷運大湖公園站 2 號出口旁錦帶橋前',
    lat: 25.0833,
    lng: 121.6033,
  },
  {
    ...
    name: '榮星花園公園',
    district: '台北市中山區',
    address: '台北市中山區民權東路三段 1 號',
    meeting: '民權東路正門噴水池前廣場',
    lat: 25.0617,
    lng: 121.5392,
  },
  {
  ...
  },
  {
    ...
    name: '南港公園',
    district: '台北市南港區',
    address: '台北市南港區東新街 170 號',
    meeting: '南港公園大牌樓入口前廣場',
    lat: 25.0447,
    lng: 121.5878,
  },
  {
  ...
  },
  {
    ...
    name: '古亭河濱公園',
    district: '台北市中正區',
    address: '台北市中正區水源路河濱步道',
    meeting: '客家文化主題公園跨堤景觀平台',
    lat: 25.0189,
    lng: 121.5233,
  },
  {
  ...
  },
  {
    ...
    name: '北投溫泉公園',
    district: '台北市北投區',
    address: '台北市北投區中山路 2 號',
    meeting: '新北投捷運站正對面噴泉廣場',
    lat: 25.1367,
    lng: 121.5056,
  },
  {
    id: 'yongchunpi-wetland',
    name: '永春陂生態濕地公園',
    district: '台北市信義區',
    address: '台北市信義區四獸山下松山路',
    meeting: '松山路側生態解說亭前',
    lat: 25.0342,
    lng: 121.5822,
  },
...
export const eventSeed: EventItem[] = [
  ...
  },
  {
    ...
    dateLabel: '今天',
    time: '上午 07:30－08:30',
    park: parks[17], // 萬坪都會公園
    spots: 10,
    maxSpots: 20,
    cost: '免費',
    audience: '鄰近板橋新埔生活圈夥伴',
    description: '繞行萬坪都會公園平坦林蔭步道兩圈，呼吸清新空氣，活力充沛。',
    items: '健走水壺、休閒防滑鞋',
    image: walkImage,
    imageAlt: '公園清晨陽光下的健走步道',
    distanceKm: 0.8,
    organizer: { name: '陳建邦', role: '板橋樂活健走隊', rating: '4.9', organized: 30, verified: true },
  },
  {
  ...
  },
  {
    ...
    dateLabel: '今天',
    time: '下午 03:00－04:30',
    park: parks[21], // 衛武營都會公園
    spots: 12,
    maxSpots: 25,
    cost: '免費',
    audience: '熱愛經典民歌與老歌同好',
    description: '攜帶簡易便攜音箱，在大草坪樹蔭下一同哼唱經典好歌交流！',
    items: '個人隨身水壺、摺疊小椅',
    image: friendsImage,
    imageAlt: '大草坪樹蔭下熱鬧的唱歌聚會',
    distanceKm: 1.5,
    organizer: { name: '高玉梅', role: '港都金曲同好會', rating: '4.8', organized: 19, verified: true },
  },
]
